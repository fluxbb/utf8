...
class Utf8IsValidTest extends TestLibTestCase
{
	protected $name = 'utf8_is_valid()';

	function test_valid_utf8()
	{
		$str = 'Iñtërnâtiônàlizætiøn';
		$this->is_true(utf8_is_valid($str));
	}
	...
	function test_invalid_utf8()
	{
		...
		$this->is_false(utf8_is_valid($str));
	}
	...
	function test_invalid_id_between_twoAnd_three()
	{
